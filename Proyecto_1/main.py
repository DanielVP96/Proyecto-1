...
def main():
    try:
        ...
        #################################################
        # Dibujar ERDOS-RENYI 30
        draw_graph.draw_from_graph_id(grafoErdos.id, open_view=True, fmt="png")

        # Dibujar ERDOS-RENYI 100
        draw_graph.draw_from_graph_id(grafoErdos.id)

        # Dibujar ERDOS-RENYI 500
        draw_graph.draw_from_graph_id(grafoErdos.id)

        # Dibujar GILBERT 30
        draw_graph.draw_from_graph_id(grafoGilbert.id)
